...
public abstract class InlineCellEditor<ColType> extends PopupPanel implements CellEditor<ColType> {
	...
	private static final class ClickDecoratorPanel extends SimplePanel {
		private final ClickListener delegate;
		...
		public void onBrowserEvent(Event event) {
			...
			switch (DOM.eventGetType(event)) {
				case Event.ONCLICK: delegate.onClick(this);
			}
		}
	}
	*/
	...
	*/
	...
	public void editCell(CellEditInfo cellEditInfo, ColType cellValue,
		...
		setPopupPosition(left + 2, top + 2);

		//set dimension equal to cell element
		setWidth(String.valueOf(cellElem.getOffsetWidth() - 10));
		setHeight(String.valueOf(cellElem.getOffsetHeight() - 10));
