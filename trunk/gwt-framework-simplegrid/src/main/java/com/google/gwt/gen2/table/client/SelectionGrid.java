...
import org.googlecode.gwt.simplegrid.client.table.event.CellHighlightEvent;
import org.googlecode.gwt.simplegrid.client.table.event.CellUnhighlightEvent;
import org.googlecode.gwt.simplegrid.client.table.event.RowHighlightEvent;
import org.googlecode.gwt.simplegrid.client.table.event.RowSelectionEvent;
import org.googlecode.gwt.simplegrid.client.table.event.RowUnhighlightEvent;
import org.googlecode.gwt.simplegrid.client.table.handler.HasTableSelectionHandlers;
 ...
 * </ul>
 */
public class SelectionGrid extends Grid implements HasTableSelectionHandlers {
  /**
  ...
  public HandlerRegistration addCellHighlightHandler(HighlightHandler<Cell> handler) {
	  return addHandler(handler, CellHighlightEvent.getType());
	}

  public HandlerRegistration addRowHighlightHandler(HighlightHandler<Row> handler) {
	  return addHandler(handler, RowHighlightEvent.getType());
	}
  
  public HandlerRegistration addCellUnhighlightHandler(UnhighlightHandler<Cell> handler) {
	  return addHandler(handler, CellUnhighlightEvent.getType());
	}

  public HandlerRegistration addRowUnhighlightHandler(UnhighlightHandler<Row> handler) {
	  return addHandler(handler, RowUnhighlightEvent.getType());
	}
  
  public HandlerRegistration addRowSelectionHandler(SelectionHandler<Row> handler) {
