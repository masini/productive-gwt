...
public class TestDefaultUserInfoConstructor {
	...
	{
		DefaultUserInfo info = new DefaultUserInfo("username","Nome","Cognome", new String[]{"Utente"}, null );
	...
	{
		DefaultUserInfo info = new DefaultUserInfo("username","Nome","Cognome",(String[]) null, new HashMap<String, String>() );
