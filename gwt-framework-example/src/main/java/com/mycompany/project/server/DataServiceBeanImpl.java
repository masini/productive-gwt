...
public class DataServiceBeanImpl extends RemoteServiceServlet implements DefaultDataSourceService<PojoBean> {
	...
	public DataResponse<PojoBean> requestRows(DataRequest request) throws Exception {
		...
		ArrayList<PojoBean> listaBean = new DataSourceGenerator().getListaPojo();
		...
		return new DataResponse<PojoBean>(resultOut, totalRowsNum);
	}
